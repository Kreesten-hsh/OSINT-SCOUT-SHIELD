                ...
                <section className="panel soft-grid relative overflow-hidden p-6 md:p-8">
                    ...
                    <div className="grid grid-cols-1 gap-4">
                        ...
                        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
                            ...
                            <label className="block text-sm">
                                <span className="mb-1 block text-xs uppercase tracking-wide text-muted-foreground">Numero suspect (obligatoire)</span>
                                <input
                                    value={phone}
                        ...
                        <div>
                            <label className="mb-1 block text-xs uppercase tracking-wide text-muted-foreground">Captures ecran (optionnel)</label>
